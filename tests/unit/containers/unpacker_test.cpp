...
int main(int argc, char const* argv[]) {
    ...
    UnPacker up(
        ...
        [](const uint8_t* head_ptr, size_t& head_size, size_t& data_size, size_t& tail_size) {
            head_size = 3;
    ...
    std::vector<uint8_t> test_in_data = {
        0x1, 0x2, 0x3,  // 鲁棒
        0x7, 0x9, 8,   1,   2,   3,   4,   5,   6,   7,   8,   0xE, 0XD, 0x7, 0x9, 8,   1,   2,   3,   4,
        5,   6,   7,   8,   0xE, 0XD, 0x7, 0x9, 8,   1,   2,   3,   4,   5,   6,   7,   8,   0xE, 0XD, 0x7,
        0x9, 8,   1,   2,   3,   4,   5,   6,   7,   8,   0xE, 0XD, 0x7, 0x9, 3,   0xA, 0xB, 0xC, 0xE, 0XD,
        0x7, 0x9, 3,   0xA, 0xB, 0xC, 0xE, 0XD, 0x7, 0x9, 3,   0xA, 0xB, 0xC, 0xE, 0XD, 0x4, 0x5, 0x6,  // 鲁棒
    };
