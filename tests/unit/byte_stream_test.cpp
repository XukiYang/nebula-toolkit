...
#include "../../include/containers/bytes_stream_v2.hpp"
...
void General_IO_Testing_V2() {
    containers::BytesStream bytes_stream;
    // 测试自定义类型IO
    TestStruct test_in_struct, test_out_struct;

    test_in_struct.age = 18;
    test_in_struct.sex = 1;
    bytes_stream << test_in_struct;
    bytes_stream >> test_out_struct;
    fmt::println("test_out_struct,age:{},sex:{}", test_in_struct.age, test_in_struct.sex);
};

int main(int argc, char const* argv[]) {
    // General_IO_Testing();
    General_IO_Testing_V2();
    return 0;
}
