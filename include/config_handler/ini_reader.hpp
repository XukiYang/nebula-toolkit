...
public:
    ...
    bool GetValue(const std::string& section, const std::string& key, bool& out_value) {
    ...
    bool GetValue(const std::string& section, const std::string& key, size_t& out_value) {
        std::string raw = GetProcessedValue(section, key);
        if (raw.empty()) return false;
    ...
    bool GetValue(const std::string& section, const std::string& key, std::string& out_value) {
        std::string raw = GetProcessedValue(section, key);
        if (raw.empty()) return false;
...
private:
    ...
    std::string GetProcessedValue(const std::string& section, const std::string& key) {
